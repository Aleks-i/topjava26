...
public abstract class JdbcMealRepository<T> implements MealRepository {
    ...
    public static class JavaJDBCMealRepository extends JdbcMealRepository<LocalDateTime> {

        public JavaJDBCMealRepository(JdbcTemplate jdbcTemplate, NamedParameterJdbcTemplate namedParameterJdbcTemplate) {
